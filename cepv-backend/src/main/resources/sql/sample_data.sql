...
insert into node_2_node (id, first_node_id, second_node_id, experiment_id, connection_time, disconnection_time) values (5, 4, 6, 1, '2014-10-10 08:00:04.123', null);
...
insert into node_2_node (id, first_node_id, second_node_id, experiment_id, connection_time, disconnection_time) values (8, 8, 9, 1, '2014-10-10 08:00:34.123', null);
...
insert into node_2_node (id, first_node_id, second_node_id, experiment_id, connection_time, disconnection_time) values (15, 7, 9, 1, '2014-10-10 08:00:21.123', null);
...
insert into query (id, node_id, deployment_time, content) values (1, 1, '2014-10-10 08:00:01.070', 'select a.custId, sum(a.price + b.price) from pattern [every a=ServiceOrder -> b=ProductOrder(custId = a.custId) where timer:within(1 min)].win:time(2 hour) where a.name in (''Repair'', b.name) group by a.custId having sum(a.price + b.price) > 100');
insert into query (id, node_id, deployment_time, content) values (2, 1, '2014-10-10 08:00:01.070', 'select a.custId, sum(a.price + b.price) from pattern [every a=ServiceOrder -> b=ProductOrder(custId = a.custId) where timer:within(1 min)].win:time(2 hour) where a.name in (''Repair'', b.name) group by a.custId having sum(a.price + b.price) > 100');
insert into query (id, node_id, deployment_time, content) values (3, 1, '2014-10-10 08:00:01.070', 'select a.custId, sum(a.price + b.price) from pattern [every a=ServiceOrder -> b=ProductOrder(custId = a.custId) where timer:within(1 min)].win:time(2 hour) where a.name in (''Repair'', b.name) group by a.custId having sum(a.price + b.price) > 100');
insert into query (id, node_id, deployment_time, content) values (4, 1, '2014-10-10 08:00:01.070', 'select a.custId, sum(a.price + b.price) from pattern [every a=ServiceOrder -> b=ProductOrder(custId = a.custId) where timer:within(1 min)].win:time(2 hour) where a.name in (''Repair'', b.name) group by a.custId having sum(a.price + b.price) > 100');
insert into query (id, node_id, deployment_time, content) values (5, 1, '2014-10-10 08:00:01.070', 'select a.custId, sum(a.price + b.price) from pattern [every a=ServiceOrder -> b=ProductOrder(custId = a.custId) where timer:within(1 min)].win:time(2 hour) where a.name in (''Repair'', b.name) group by a.custId having sum(a.price + b.price) > 100');
