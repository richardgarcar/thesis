        ...
        var getExperimentData = function () {
            RestApiService.getRoot()
                .then(function (resource) {
                    return resource.$get('filteredExperiments', {
                        ...
                        'gtStart': searchOptions.gtStart,
                        'ltStart': searchOptions.ltStart,
                        'gtEnd': searchOptions.gtEnd,
                        'ltEnd': searchOptions.ltEnd
                    });
                })
                .then(function (resource) {
                    $scope.experimentGridOptions.data = [];
